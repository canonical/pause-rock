...
Using GitHub, file a [Private Security Report](https://github.com/canonical/pause-rock/security/advisories/new) with:
- A description of the issue
- Steps to reproduce the issue
- Affected versions of the `pause-rock` package
...
Thank you for contributing to the security and integrity of the `pause-rock`!
